...
const styleFiles = [
 ...
 './src/styles/common/main-page.scss',
 './src/styles/common/about-page.scss',
 './src/styles/common/contact-us.scss',
 './src/styles/common/main-services.scss',
 './src/styles/common/main-faq.scss',
 './src/styles/common/main-law.scss',
 './src/styles/common/footer.scss',
 './src/styles/common/slick.scss',
 './src/styles/common/slick-theme.scss',
];
...
gulp.task('img-compress', () => {
    return gulp.src('./assets/**/*.{jpg,png,svg,gif,ico,webp}')
    .pipe(imagemin({
        progressive: true,
